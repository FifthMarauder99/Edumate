...
CREATE TABLE courses_per_semester (
    ...
    PRIMARY KEY(course_id,cycle_id)
)
...
/* So when we assign a student to a course through admin panel this table 
should be updated */
...
/* So when we assign a professor to a course through admin panel this table 
should be updated */
CREATE TABLE courseAssignment_professor (
    course_id VARCHAR(20) NOT NULL,
    semester_id VARCHAR(20) NOT NULL,
    user_id INTEGER NOT NULL,
    PRIMARY KEY (course_id,semester_id,student_id)
...
INSERT INTO TABLE enrollments(course_id,semester_id,user_id,enrollment_date)
...
INSERT INTO TABLE courseAssignment_professor(course_id,semester_id,user_id)
